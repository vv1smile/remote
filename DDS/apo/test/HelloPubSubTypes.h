...
#ifndef _HELLO_PUBSUBTYPES_H_
#define _HELLO_PUBSUBTYPES_H_
...
#error Generated Hello is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
